...
const ProductUiDesc = () => {
  ...
  const renderServiceDetails = () => {
    switch (product.serviceType) {
      case "hall":
        return (
          <div className="space-y-6 bg-white shadow-md rounded-2xl p-6 border border-gray-100">
            {/* Header */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700">
              ...
              <p>
                ...
                {product.hallCapacity || "N/A"} Guests
              </p>
              <p className="capitalize">
                <span className="font-semibold text-gray-900">
                  Decor Starts From:
                </span>{" "}
                {product.halldecor || "N/A"}
              </p>
              <p>
                <span className="font-semibold text-gray-900">
                  Price / Head:
                </span>{" "}
                Rs {product.hallPricePerHead || "N/A"}
              </p>
              <p className="capitalize">
                <span className="font-semibold text-gray-900">Parking:</span>{" "}
                {product.hallparking || "N/A"}
              </p>
              <p className="capitalize">
                <span className="font-semibold text-gray-900">Catering:</span>{" "}
                {product.hallcatering || "N/A"}
              </p>
            </div>

            {/* Staff Section */}
            {product.staff && (
              <div className="bg-gray-50 flex  items-center gap-0.5  p-4 rounded-lg border border-gray-200">
                ...
                <div className="flex flex-wrap gap-2 ">
                  {product.staff &&
                    JSON.parse(product.staff).map((item, index) => (
                      <span
                        key={index}
                        className="text-lg bg-gray-100 px-2 py-1 rounded capitalize"
                      >
                        {item}
                      </span>
                    ))}
            ...
            <div className="flex flex-col-reverse md:flex-row gap-4">
              ...
              <div className="flex-1">
                <img
                  ...
                  alt={product.title}
                  className="w-full h-full md:h-200 object-cover rounded-xl shadow-md"
                />
              </div>
            </div>
