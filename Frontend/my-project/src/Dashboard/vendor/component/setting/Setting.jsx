    ...
    <div className="min-h-screen z-0  pl-10 lg:pl-80 pt-26  bg-[#020617] text-slate-200 py-12 px-4 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 p-2 rounded-2xl flex items-center gap-4">
            <div className="px-4 py-2 bg-gradient-to-r from-pink-600 to-rose-500 rounded-xl shadow-lg shadow-pink-600/20 text-white font-black text-sm tracking-tighter">
              PREMIUM PARTNER
            </div>
          </div>
        </div>
